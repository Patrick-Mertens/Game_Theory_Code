...
U_free_or_not_free = ['Not_Free'] #['Free','Not_Free']
sigma_free_or_not_free = ['Not_Free'] #['Free','Not_Free']
all_cases = ["case3", "case0", "case4", "case5", "exp_r", "exp_K", "exp_K_neg", "exp_both"]
WHO = 'Different_Cases_Run_attempt_2'

for free_sigma_val in sigma_free_or_not_free:
    if free_sigma_val == 'Free':

        Val_for_run_model_unsaved = 'sigma'

    if free_sigma_val == 'Not_Free':
        Val_for_run_model_unsaved = 'k'


    for U_switch in U_free_or_not_free:
        for case_run in all_cases:
            Cases_Path = os.path.join(dataset_path, 'Results_nsclc_paper_fighting_treatment', WHO,case_run,f"U_is_{U_switch}",f"model_unsaved_val_is_{Val_for_run_model_unsaved}")
            ...
            for studyName in studies:
                ...
                for functionToFit in functions:
                                ...
                                if len(tumorFiltered_Data) >= 6:
                                    ...
                                    try:
                                        ...
                                        list_x, list_u, list_Kmax, error, list_b, list_s, der = run_model_fixed_unsaved(days=firstTime,
                                                                                                                ...
                                                                                                                a_val=a0,
                                                                                                                c_val=c0,
                                                                                                                free=Val_for_run_model_unsaved, #this was sigma
                                                                                                                g_val=g0)
                                        ...
                                        if U_switch == 'Free':
                                            list_x1, list_u1, list_Kmax1, error1, list_b1, list_s1 = run_model_sim_free_u(
                                                days=time,
                                            ...
                                            #print("Not Free run model")
                                            list_x1, list_u1, list_Kmax1, error1, list_b1, list_s1 = run_model_sim_not_free_u(
                                        ...
                                        save_path = os.path.join(Cases_Path,f"{studyName}", "Alt", functionToFit,'Plots',f"{arm}",f"{trend}")  # added arm to it
                    ...
                    full_Pickle_directory_path = os.path.join(Cases_Path,f"{studyName}", "Alt", functionToFit,'Pickle_Files',f"{arm}")
