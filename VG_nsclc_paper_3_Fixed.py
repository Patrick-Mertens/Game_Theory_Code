...
#Testing switch
Test = 2
resistance_question = 'Fluctuate' #trends = ['Up', 'Down', 'Fluctuate', 'Evolution'] #Evolution,Up,DownFluctuate Down done
...
for studyName in studies:
    ...
    for functionToFit in functions:
                    ...
                    if len(tumorFiltered_Data) >= 6:
                        ...
                        try:  # C, this try box need to move to the left, so that it is in the body of the
                            ...
                            if Test == 1:
                                ...
                                # Subdirectories
                                sub_dirs = ["Check_values", "VG"]

                                # Full dataset path
                                target_dir = os.path.join(dataset_path,'Results_nsclc_paper_3','VG',f"{studyName}", "Sigma 0", functionToFit,resistance_question, *sub_dirs)
                                ...
                                PR_k0, PR_b0, PR_group, PR_case0, PR_u0, PR_sigma0, PR_K0, PR_a0, PR_c0, PR_g0 = PR_separate_by_size(
                                    studyName,
                                    arm,
                                    PR_Size1,
                                    PR_Size2,
                            ...
                            if trend == resistance_question:
                                ...
                                save_path = os.path.join(dataset_path,'Results_nsclc_paper_3','VG',f"{studyName}", "Sigma 0", functionToFit,resistance_question,'Plots', f"{arm}")  # added arm to it
                            ...
                            directory_parm = os.path.join(dataset_path, 'Results_nsclc_paper_3','VG',f"{studyName}", "Sigma 0",functionToFit,resistance_question, paramControl,  f"{arm}")  # C, I have to many patients so let me determine which one is used
        ...
        full_Pickle_directory_path = os.path.join(dataset_path, 'Results_nsclc_paper_3','VG',f"{studyName}", "Sigma 0", functionToFit,resistance_question,'Pickle_Files')
