...
for run in range(runers):
    ...
    for studyName in studies:
        ...
        for functionToFit in functions:
                    ...
                    if  'INV-T001' in temp:
                        ...
                        if len(tumorFiltered_Data) >= 6:
                            ...
                            if SaveERROR == True:
                                ...
                                target_dir = os.path.join(dataset_path, 'Error_Params_Changed_formula_edit_I_hate_this_Run', studyName, functionToFit, arm)
            ...
            # Inside your loop
            output_directory = os.path.join(dataset_path, functionToFit,"different_seed",f"seed_{seed}",f"run_{run}")
