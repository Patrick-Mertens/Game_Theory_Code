...
paramControl = "4_November" #C, additionaly dirrectonary control
                    ...
                    if len(tumorFiltered_Data) >= 6:
                        ...
                        try:
                            ...
                            if arm == 'DOCETAXEL' or arm == 'Docetaxel':
                                ...
                                #C, to Get the patient specific params first
                                ...
                                list_x1, list_u1, list_Kmax1, error1, list_b1, list_s1, final = run_model_m(days=time1,
                                                                                                            ...
                                                                                                            g_val=g0,
                                                                                                            obj='final',
                                                                                                            Chemo_or_Immuno= "Chemo", step_val_on = True) #C, IMPORTANT, this need to switch ACCORDINGLY
