    ...
    for studyName in studies:
        ...
        for functionToFit in functions:
                        ...
                        if len(tumorFiltered_Data) >= 6:
                            ...
                            try:  # C, this try box need to move to the left, so that it is in the body of the
                                ...
                                if Test == 1:
                                    ...
                                    # Full dataset path
                                    target_dir = os.path.join(dataset_path,WHO,f"PR_{case_check}",f"{studyName}", "Sigma 0", functionToFit,resistance_question, *sub_dirs)
                                ...
                                if Save == True:
                                    for resistance_question in Trend_resistance:
                                        if trend == resistance_question:
                                            ...
                                            save_path = os.path.join(dataset_path,WHO,f"PR_{case_check}",f"{studyName}", "Sigma_0", functionToFit,resistance_question,'Plots',
            ...
            if Save == True:
                ...
                full_Pickle_directory_path = os.path.join(dataset_path, WHO,f"PR_{case_check}" ,f"{studyName}", "Sigma_0", functionToFit,'Pickle_Files')
