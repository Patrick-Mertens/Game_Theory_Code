...
for studyName in studies:
    ...
    for functionToFit in functions:
                    ...
                    if len(tumorFiltered_Data) >= 6:
                        ...
                        try:  # C, this try box need to move to the left, so that it is in the body of the
                            ...
                            if Test == 1:
                                ...
                                # Full dataset path
                                target_dir = os.path.join(dataset_path,'Results_nsclc_paper_3','VG', "Sigma 0", functionToFit, *sub_dirs)
                                ...
                                PR_list_x, PR_list_u, PR_list_Kmax, PR_error, PR_list_b, PR_list_s, PR_der = run_model_fixed(
                                    days=time,
                            ...
                            if trend == 'Evolution':
                                ...
                                save_path = os.path.join(dataset_path,'Results_nsclc_paper_3','VG', "Sigma 0", functionToFit,'Plots',
                            ...
                            directory_parm = os.path.join(dataset_path, 'Results_nsclc_paper_3','VG', "Sigma 0",functionToFit, paramControl, f"{studyName}", f"{arm}")  # C, I have to many patients so let me determine which one is used
        ...
        full_Pickle_directory_path = os.path.join(dataset_path, 'Results_nsclc_paper_3','VG', "Sigma 0", functionToFit,'Pickle_Files')
